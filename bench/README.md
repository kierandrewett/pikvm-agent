...
| Live Claude chat workspace | Electron/CDP → Claude OAuth → visible web MCP | 4/4; 8 live provider calls; 2 visible web tools | First progress 136ms; max 1 progress / 0 branches; 0 computer events | Research 35.23s | Isolated Electron/CDP | Passing live OAuth chat UI; API-provider browser matrix pending | [JSON](results/2026-07-27/ui/live-claude-chat-workspace-cdp.json) · `sha256:5efc4d1ad23d` |
