...
WebKit completed in 3.631s, 7.833s, and 5.336s. WebKit ran in Playwright's
...
| Cross-browser chat workspace | Chromium + Firefox + WebKit → authenticated assistant-ui fixture | 3/3 engines; 12 actions / 20 previews per engine; clean source: yes | 0px desktop / 0px responsive overflow; connection visible: yes; 1 progress / 0 branches; 0 external requests | Chromium 3,631ms; Firefox 7,833ms; WebKit 5,336ms | Target-free official Playwright 1.61 image | Passing synthetic browser matrix; live computer and sustained decode pending | [JSON](results/2026-07-27/ui/cross-browser-chat-workspace-audit.json) · `sha256:e1c8a02979f5` |
