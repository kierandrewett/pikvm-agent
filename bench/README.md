...
summed per file is 333,078 bytes for JavaScript and 18,223 bytes for CSS.
...
| Computer-action timeline visual audit | assistant-ui timeline → live fixture → approval boundary | 1,200 events / 12 actions; 119 frontend + 24 Python | 119/119 + 24/24; 1,204 full Python / 1 skipped; 0px narrow / 0px 200% action overflow; approval held with 298px scroll | 333,078-byte gzip JS; 18,223-byte gzip CSS | Target-free browser audit | Desktop, 390×844, and effective 200% passing; cross-browser pending | [JSON](results/2026-07-27/ui/computer-action-timeline-visual-audit.json) · `sha256:3adfe3670e23` |
